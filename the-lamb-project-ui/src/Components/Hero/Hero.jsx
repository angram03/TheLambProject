...
const Hero = () => {
  return (
    ...
    <div className="relative bg-[#015239] rounded-sm text-white p-10 text-center py-80">
      ...
      <div className="relative z-10 ">
        <h2 className="pb-6 text-9xl text-white">Your Travel Advisor</h2>
        <h3 className="pb-3 text-6xl text-white">
          From Occupation to Exploration, Let Us Reveal Your Dream City!
        </h3>
        <br></br>

        <button className=" bg-white hover:bg-[#E4FAEE] text-[#015239] text-3xl px-2 py-4 rounded-lg">
